...
export const AdminAutoRecommendations: React.FC<AdminAutoRecommendationsProps> = ({
  ...
  const runCamarillaAnalysis = (pairSymbol: string): AutoRecommendation => {
    ...
    return {
      ...
      pair: pairSymbol,
      type: direction,
      entryPrice: rawSignal.entry,
      tp1: rawSignal.takeProfits[0] || (livePrice * 1.01),
      tp2: rawSignal.takeProfits[1] || (livePrice * 1.02),
      tp3: rawSignal.takeProfits[2] || (livePrice * 1.03),
