...
import { FIBONACCI_AND_GANN_GROUPS, FibGannTool } from './fibGannData';

interface FibGannFlyoutProps {
  isOpen: boolean;
  onClose: () => void;
  selectedToolId: string;
  onSelectTool: (tool: FibGannTool) => void;
  topOffset: number;
}

export const FibGannFlyout: React.FC<FibGannFlyoutProps> = ({
  isOpen,
  onClose,
  selectedToolId,
  onSelectTool,
  ...
  return (
    ...
    >
      ...
      >
        {FIBONACCI_AND_GANN_GROUPS.map((group, groupIdx) => (
              ...
              {group.items.map((tool) => {
                ...
                return (
                  ...
                  >
                    ...
                    {/* Tool Name & Icon (RTL alignment matching screenshot) */}
