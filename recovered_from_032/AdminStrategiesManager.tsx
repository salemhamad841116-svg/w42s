...
export const AdminStrategiesManager: React.FC<AdminStrategiesManagerProps> = ({
  ...
  const handleRunBacktest = (strat: StrategyPlugin) => {
    ...
    const result = runBacktest({
      ...
      barsCount: 500,
      riskRewardRatio: strat.defaultRiskRatio || '1:2.5',
      minConfidence: strat.minConfidenceThreshold || 80,
    });
    ...
    <div className="space-y-6 dir-rtl text-right font-sans">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 relative z-10">
          ...
          <div className="flex items-center gap-3 shrink-0 flex-wrap">
            <button
              ...
              className="px-4 py-3 rounded-2xl bg-emerald-500/20 border border-emerald-500/40 text-emerald-300 hover:bg-emerald-500/30 font-black text-xs transition-all flex items-center gap-2 active:scale-95"
            >
            ...
            <button
              ...
              className="px-4 py-3 rounded-2xl bg-rose-500/20 border border-rose-500/40 text-rose-300 hover:bg-rose-500/30 font-black text-xs transition-all flex items-center gap-2 active:scale-95"
            >
            ...
            >
              ...
              <span>إضافة استراتيجية جديدة ➕</span>
            </button>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        <div className="bg-zinc-900/90 border border-zinc-800 rounded-3xl p-5 shadow-xl flex items-center justify-between">
          <div>
            <span className="block text-xs font-bold text-zinc-400">إجمالي الاستراتيجيات:</span>
            <span className="text-2xl font-black text-white font-mono mt-1 block">{strategies.length} استراتيجية</span>
          </div>
        ...
        <div className="bg-zinc-900/90 border border-zinc-800 rounded-3xl p-5 shadow-xl flex items-center justify-between">
          <div>
            <span className="block text-xs font-bold text-zinc-400">الاستراتيجيات النشطة حالياً:</span>
            <span className="text-2xl font-black text-emerald-400 font-mono mt-1 block">{activeCount} نشطة 🟢</span>
          </div>
        ...
        <div className="bg-zinc-900/90 border border-zinc-800 rounded-3xl p-5 shadow-xl flex items-center justify-between">
          <div>
            <span className="block text-xs font-bold text-zinc-400">متوسط نسبة النجاح (Win Rate):</span>
            <span className="text-2xl font-black text-amber-400 font-mono mt-1 block">{avgWinRate}% 🎯</span>
          </div>
          <div className="p-3 bg-amber-500/10 border border-amber-500/30 text-amber-400 rounded-2xl">
        ...
        <div className="bg-zinc-900/90 border border-zinc-800 rounded-3xl p-5 shadow-xl flex items-center justify-between">
          <div>
            <span className="block text-xs font-bold text-zinc-400">إجمالي نقاط الأرباح (P&L):</span>
            <span className="text-2xl font-black text-teal-400 font-mono mt-1 block">+{totalPipsAll.toLocaleString()} Pips</span>
          </div>
